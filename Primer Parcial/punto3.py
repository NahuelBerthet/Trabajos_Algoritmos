...
from lista import by_specie, search, by_name
#Punto a.
...
for index, jedi in enumerate(jedis):
    if jedi["name"] == "Ahsoka Tano":
        print(f"Info Ahsoka: {jedi}")
for index, jedi in enumerate(jedis):
    if jedi["name"] == "Kit Fisto":
        print(f"Info Kit Fisto: {jedi}")

#Punto c.
print("------------------------")
for jedi in jedis:
    if jedi["master"] is not None and jedi['master'].startswith('Luke'):
        print("Padawans de Luke Sywalker: " ,jedi['name'])

for jedi in jedis:
    if jedi["master"] is not None and jedi['master'].startswith('Yoda'):
        print("Padawans de Yoda: " ,jedi['name'])
    
#Punto d.
print("------------------------")
print("Jedis de especies humanas y Twi'lek: ")
for jedi in jedis:
    if jedi["species"] in ["Twi'lek", "Human"]:
...
#Punto g
print("------------------------")
print("Jedis con mas de un color: ")
for jedi in jedis:
    if jedi["lightsaber_color"] in ["Yellow","Purple"]:
        print(jedi["name"], "-",jedi["lightsaber_color"])

#Punto h
print("------------------------")
print("Jedis padawans de Qui-Gon Jinn o Mace Windu:")
for jedi in jedis:
    if jedi["master"] in ["Qui-Gon Jinn", "Mace Windu"] is not None:
        print(jedi["name"])
    else:
        break
...
#Punto i
print("------------------------")
print("Jedis Grand Master:")
for jedi in jedis:
    if jedi["rank"] == "Grand Master":
        print(jedi["nombre"])
# for jedi in jedis:
#     if jedi["rank"] == "Jedi Master":
#         print(jedi["nombre"])