...
#a.Eliminar nodo de Linterna verde
for heroe in super_heroes:
    if heroe["nombre"] == "Linterna Verde":
        super_heroes.remove(heroe)
        break

#b.Mostrar anio aparicion Wolverine

for heroe in super_heroes:
    if heroe["nombre"] == "Wolverine":
        print("---------Año de aparicion: Wolverine----------")
        print(heroe["año_aparicion"])
        break

#c.Cambiar casa de Dr. Strange
for heroe in super_heroes:
    if heroe["nombre"] == "Doctor Strange":
        heroe["casa_comic"] = "DC Comics"
        break
# for heroe in super_heroes:
#     if heroe["nombre"] == "Doctor Strange":
...
#d.Nombre de los que mencionan en su biografia armadura, traje.
print("---------Heroes con traje/armadura----------")
...
for heroe in super_heroes:
    if heroe["año_aparicion"] < 1963:
        heroe_previo_1963.append(heroe)
        break
for heroe in heroe_previo_1963:
    print(heroe["nombre"])
    break
